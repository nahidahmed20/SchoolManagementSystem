...
@section('title','Parent List | School Management System')
@section('content')
...
<div class="page-title" style="display: flex; justify-content: space-between; align-items: center;">
    <h2><span class="fa fa-users"></span> Parent Table</h2>
    @can('create.parent')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div style="display: flex; justify-content: center; gap: 5px; align-items: center;">
                                            @can('edit.parent')
                                                <a href="{{ route('parents.edit', $parent->id) }}" class="btn btn-info btn-sm">
                                                    <i class="fa fa-pencil"></i> Edit
                                                </a>
                                            @endcan
                                            @can('delete.parent')
                                                <form method="POST" action="{{ route('parents.destroy', $parent->id) }}" class="delete-form">
                                                    @csrf
                                                    @method('DELETE')
                                            ...
                                            @can('mystudent.parent')
                                                <a href="{{ route('parents.mystudents', $parent->id) }}" class="btn btn-warning btn-sm">
