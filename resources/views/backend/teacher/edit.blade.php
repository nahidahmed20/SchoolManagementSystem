                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" value="{{ old('name', $teacher->name) }}" class="form-control" placeholder="Enter First Name" required>
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                                    <input type="text" name="last_name" value="{{ old('last_name', $teacher->last_name) }}" class="form-control" placeholder="Enter Last Name">
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="email" name="email" value="{{ old('email', $teacher->email) }}" class="form-control" placeholder="Enter Email" required>
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="date" name="date_of_birth" value="{{ old('date_of_birth', $teacher->date_of_birth) }}" class="form-control">
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                    <input type="date" name="date_of_joining" value="{{ old('date_of_joining', $teacher->date_of_joining) }}" class="form-control">
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="designation" value="{{ old('designation', $teacher->designation) }}" class="form-control">
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="number" value="{{ old('number', $teacher->number) }}" class="form-control">
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
                                    <input type="text" name="work_experience" value="{{ old('work_experience', $teacher->work_experience) }}" class="form-control">
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <textarea name="note" id="note" class="form-control" rows="4" placeholder="Write your note here...">{{ old('note', $teacher->note) }}</textarea>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-2">
                                    <img id="preview-image" 
                                         src="{{ $teacher->image ? asset($teacher->image) : asset('backend/img/dummy-image.webp') }}" 
                                         alt="Profile Preview" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">                                            
                                <div class="input-group">
                                    ...
                                    <input type="password" name="password" class="form-control" placeholder="Enter New Password (leave blank if unchanged)">
                                </div>       
                                @error('password')
