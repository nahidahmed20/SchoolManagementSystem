...
@section('title','Permissions List | School Management System')
@section('content')
...
<div class="page-title" style="display: flex; justify-content: space-between; align-items: center;">
    <h2><span class="fa fa-arrow-circle-o-left"></span> Permissions Table</h2>
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <table id="permissionsTable" class="table table-striped table-bordered nowrap" style="width:100%">
                        <thead>
                            <tr>
                                <th>#SL</th>
                                <th>Name</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div style="display: flex; gap: 5px; align-items: center;">
                                            @can('edit permission')
                                                <a href="{{ route('permission.edit', $permission->id) }}" class="btn btn-info btn-sm">
                                                    <i class="fa fa-pencil"></i> Edit
                                                </a>
                                            @endcan
                                            @can('delete permission')
                                                <form method="GET" action="{{ route('permission.destroy', $permission->id) }}" class="delete-form">
                                                    @csrf
