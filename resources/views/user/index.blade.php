...
@section('title','User List | School Management System')
@section('content')
...
<div class="page-title" style="display: flex; justify-content: space-between; align-items: center;">
    <h2><span class="fa fa-arrow-circle-o-left"></span> User Table</h2>
    @can('create user')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div style="display: flex; gap: 5px; align-items: center;">
                                            ...
                                            @endcan
                                            @can('delete user')
                                                <form method="GET" action="{{ route('user.destroy', $user->id) }}" class="delete-form">
                                                    @csrf
